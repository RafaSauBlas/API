...
class RegistroVenta extends Controller
{
 ...
 public function PREPARAR($vale, $monto, $plazo, $calle, $colonia, $ciudad, $estado){
    try{
       ...
       $distrib = $cliente_id->FAin_IdDistri;

        $cliente = DB::table("FATB_Clientes")->where("FAnv_CveCliente", $id)->select("FAnv_CveCliente", "FAnv_Razon", "FAnv_Nombres", "FAnv_APaterno",
                                                                                     "FAnv_AMaterno")->first();

    //$vale, $cliente, $calle, $colonia, $estado, $ciudad, $monto, $plazo, $distrib
       $folio = self::ENCABEZADO($vale, $cliente, $calle, $colonia, $estado, $ciudad, $monto, $plazo, $distrib);
       ...
       for($i = 1; $i <= $plazo; $i++){
           $verif = self::DETALLADO($folio, $vale, $i, $plazo, $monto, $fecha[$indice], $seguro, $distrib);
           $indice +=1;
       }
 ...
 public function ENCABEZADO($vale, $cliente, $calle, $colonia, $estado, $ciudad, $monto, $plazo, $distrib){
    try{
       ...
       DB::table("PRU_Contrato")->insert([
           ...
           "CACon_TipoCredito" => "M",
           "CACon_Contrato" => $vale,
           "CACon_FecCotiza" => Carbon::now()->format("d-m-y H:m:s.000"),
           "CACon_FechaContrato" => Carbon::now()->format("d-m-y H:m:s.000"),
           ...
           "CACon_FechaInicio" => Carbon::now()->format("d-m-y H:m:s.000"),
           ...
           "CACon_FechaAutoriza" => Carbon::now()->format("d-m-y H:m:s.000"),
           "CACon_Observa" => "",
           "CACon_Id" => "ADMIN",
           "CACon_Fecha" => Carbon::now()->format("d-m-y H:m:s.000"),
           "CACon_Movtos" => 0,
           "CACon_CtaContable" => "",
           "CACon_CtaIntxDev" => "",
           "CACon_TextoLegal" => "",
           ...
           "CACon_SeguroBenef" => 0,
           "CACon_SeguroParen" => 0,
           "CACon_SeguroFecNac" => Carbon::now()->format("d-m-y H:m:s.000"),
           "CACon_CliFecNac" => Carbon::now()->format("d-m-y H:m:s.000"),
           "CACon_Poliza" => "",
           "CACon_Categoria" => "",
           "CACon_SegAuto" => 0,
           "CACon_Tipo_Vale" => "V",
       ...
       return $id;
    //    //return JSON("Vale" -> $vale, $cliente, $calle, $colonia, $estado, $ciudad, $monto, $plazo, $distrib);
    //return Carbon::now()->format("d-m-y H:m:s.000");
    }
    catch(Throwable $e){
      report($e);
      return false;
 ...
 public function DETALLADO($folio, $vale, $no, $plazo, $monto, $fecha, $seguro, $distrib){
   try{
     ...
     DB::table("PRU_ContratoDet")->insert([
         ...
         "CADet_docextra" => "",
         "CADet_Print" => 1,
         "CADet_folio" => $folio->CACon_Folio,
         "CADet_fechagenera" => Carbon::now()->format("d-m-y H:m:s.000"),
         "CADet_contrato" => $vale,
         ...
         "CARec_cveuni" => "",
         "CADet_Id" => "ADMIN",
         "CADet_fecha" => Carbon::now()->format("d-m-y H:m:s.000"),
         "CADet_CveUni" => "",
         "CADet_IvaInteres" => 0,
         "CADet_ShowCV" => 1,
         "SELCEL" => 0,
         ...
         "CADet_VenciDocto" => Carbon::now()->format("d-m-y H:m:s.000"),
         "CADet_SaldoSeg" => 0,
         "CaDet_PAInt" => NULL,
